    ...
    function IsPC() {
        ...
        for (var v = 0; v < Agents.length; v++) {
            if (userAgentInfo.indexOf(Agents[v]) > 0) {
                ...
                window.location.href = "MobileIndex.php";
                break;
            }
        }
    }
...
<div style="width: 100%">
    ...
    <div style="width: 100%; text-align: center">
        <a href="oldnews/OldNews.php" style=" text-decoration: none; color: orange; font-size: 15px">查看历史新闻</a>
    </div>
</div>
